...
public class EnemyDamageOnHit : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other) // object has this component, counts as a collider event and will trigger below
    {
        ...
        if (otherHealth != null && other.CompareTag("Player")) //only apply damage if other gameobject has health component and tag is player
        {
