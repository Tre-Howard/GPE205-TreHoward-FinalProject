...
public class EnemyShooter : Shooter
{
    ...
    public override void Shoot(GameObject shellPrefab, float fireForce, float damageDone, float lifespan)
    {
        ...
        if (canShoot == true)
        {
            ...
            EnemyDamageOnHit doh = newShell.GetComponent<EnemyDamageOnHit>();
            ...
            /*if (audioSource != null)
            {
                audioSource.PlayOneShot(tankPawn.audioClips[3]);
            }
            else
            {
            ...
            NoiseMaker noiseMaker = GetComponentInParent<NoiseMaker>();
            if (noiseMaker != null)
            {
                noiseMaker.SetVolume(20f);
            }
            else
            {
                Debug.Log("noiseMaker in TankShooter failed");
            }*/
        }
        else
        {
